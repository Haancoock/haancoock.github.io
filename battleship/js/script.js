var Module = (function(){
	...
	//Функция отвечает за выстрел компьютера
	...
	var _whoisWinner = () => {
		var comp=0, //сюда записывается кол-во потопленных палуб компьютером
		...
		// То же самое, только если победил компьютер 
		 if(comp == 20){
			$('.infobar-text').text('Компьютер победил!:( Чтобы отыграться нажми "Заново"');
			_fillTheOneField('cheater');
			$('#playerFieldBlocker').show();
			$('#compFieldBlocker').show();	
		}
